...
license: MIT
compatibility: Uses domain_knowledge scaffolding (domain_knowledge/scripts/create-new-feature.sh).
metadata:
  version: "1.0"
  generatedBy: "1.2.0"
---
...
4. **Create artifacts in sequence until apply-ready**
   ...
   a. **For each artifact that is `ready` (dependencies satisfied)**:
      - Get instructions:
      Use the spec and the templates under `domain_knowledge/templates/` for artifact structure; follow the spec's `instruction` guidance where present.
